...
# Code for /mat/karmamaterial1
hou_node = hou_parent.createNode("subnet", "karmamaterial1", run_init_scripts=False, load_contents=True, exact_type_name=True)
snail_re_node.append(hou_node.path())
hou_node.move(hou.Vector2(-10.5865, 8.90434))
...
# Code for /mat/karmamaterial1/shader_referencetype parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/karmamaterial1")
...
# Code for /mat/karmamaterial1/inputs
...
# Code for /mat/karmamaterial1/mtlxstandard_surface
...
# Code for /mat/karmamaterial1/mtlxstandard_surface/folder0 parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/karmamaterial1/mtlxstandard_surface")
hou_parm = hou_node.parm("folder0")
hou_parm.deleteAllKeyframes()
hou_parm.set(1)


# Code for /mat/karmamaterial1/mtlxstandard_surface/base_color parm tuple
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/karmamaterial1/mtlxstandard_surface")
...
# Code for /mat/karmamaterial1/mtlxstandard_surface/metalness parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/karmamaterial1/mtlxstandard_surface")
...
# Code for /mat/karmamaterial1/mtlxdisplacement
...
# Code for /mat/karmamaterial1/Material_Outputs_and_AOVs
...
hou_node.move(hou.Vector2(2.4426, -3.8725))
hou_node.setDebugFlag(False)
hou_node.setDetailLowFlag(False)
hou_node.setDetailMediumFlag(False)
hou_node.setDetailHighFlag(True)
...
# Code for /mat/karmamaterial1/Material_Outputs_and_AOVs/name1 parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/karmamaterial1/Material_Outputs_and_AOVs")
hou_parm = hou_node.parm("name1")
hou_parm.deleteAllKeyframes()
hou_parm.set("surface")


# Code for /mat/karmamaterial1/Material_Outputs_and_AOVs/name2 parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/karmamaterial1/Material_Outputs_and_AOVs")
...
# Code for /mat/karmamaterial1/material_properties
...
# Code to establish connections for /mat/karmamaterial1/Material_Outputs_and_AOVs
