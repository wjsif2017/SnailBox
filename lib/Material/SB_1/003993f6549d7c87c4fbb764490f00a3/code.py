...
hou_node.move(hou.Vector2(-7.06778, 2.43518))
...
# Code for /mat/random_uv/shader_referencetype parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv")
...
# Initialize parent node variable.
if locals().get("hou_parent") is None:
    hou_parent = hou.node("/mat/random_uv")

# Code for /mat/random_uv/__netbox1
...
# Code for /mat/random_uv/__netbox2
...
# Code for /mat/random_uv/__netbox3
...
# Code for /mat/random_uv/__netbox4
...
# Code for /mat/random_uv/mtlxstandard_surface
...
# Code for /mat/random_uv/mtlxstandard_surface/folder0 parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxstandard_surface")
...
# Code for /mat/random_uv/Material_Outputs_and_AOVs
...
# Code for /mat/random_uv/Material_Outputs_and_AOVs/name1 parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/Material_Outputs_and_AOVs")
...
# Code for /mat/random_uv/material_properties
...
# Code for /mat/random_uv/mtlximage1
...
# Code for /mat/random_uv/mtlximage1/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlximage1")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
hou_parm.set("color3")


# Code for /mat/random_uv/mtlximage1/file parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlximage1")
...
# Code for /mat/random_uv/mtlxtexcoord2
...
# Code for /mat/random_uv/mtlxtexcoord2/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxtexcoord2")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
...
# Code for /mat/random_uv/uv_scale
...
# Code for /mat/random_uv/uv_scale/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/uv_scale")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
hou_parm.set("vector2")


# Code for /mat/random_uv/uv_scale/in2_vector2 parm tuple
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/uv_scale")
...
# Code for /mat/random_uv/mtlxadd4
...
# Code for /mat/random_uv/mtlxadd4/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxadd4")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
...
# Code for /mat/random_uv/mtlxcellnoise2d1
...
# Code for /mat/random_uv/mtlxmultiply5
...
# Code for /mat/random_uv/mtlxmultiply5/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxmultiply5")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
hou_parm.set("vector2")


# Code for /mat/random_uv/mtlxmultiply5/in2_vector2 parm tuple
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxmultiply5")
hou_parm_tuple = hou_node.parmTuple("in2_vector2")
hou_parm_tuple.deleteAllKeyframes()
...
# Code for /mat/random_uv/uv_rotate
...
# Code for /mat/random_uv/uv_rotate/amount parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/uv_rotate")
...
# Code for /mat/random_uv/mtlxmodulo2
...
# Code for /mat/random_uv/mtlxmodulo2/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxmodulo2")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
hou_parm.set("vector2")
...
# Code for /mat/random_uv/mtlxsubtract1
...
# Code for /mat/random_uv/mtlxsubtract1/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxsubtract1")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
hou_parm.set("vector2")


# Code for /mat/random_uv/mtlxsubtract1/in2_vector2 parm tuple
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxsubtract1")
hou_parm_tuple = hou_node.parmTuple("in2_vector2")
hou_parm_tuple.deleteAllKeyframes()
...
# Code for /mat/random_uv/mtlxadd5
...
# Code for /mat/random_uv/mtlxadd5/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxadd5")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
hou_parm.set("vector2FA")


# Code for /mat/random_uv/mtlxadd5/in2_vector2 parm tuple
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxadd5")
hou_parm_tuple = hou_node.parmTuple("in2_vector2")
hou_parm_tuple.deleteAllKeyframes()
...
# Code for /mat/random_uv/mtlxrange1
...
# Code for /mat/random_uv/mtlxrange1/outlow parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxrange1")
hou_parm = hou_node.parm("outlow")
hou_parm.deleteAllKeyframes()
hou_parm.set(-90)


# Code for /mat/random_uv/mtlxrange1/outhigh parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxrange1")
...
# Code for /mat/random_uv/mtlxmultiply6
...
# Code for /mat/random_uv/mtlxmultiply6/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxmultiply6")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
hou_parm.set("vector2FA")
...
# Code for /mat/random_uv/mtlxrange2
...
# Code for /mat/random_uv/mtlxrange2/inhigh parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxrange2")
hou_parm = hou_node.parm("inhigh")
hou_parm.deleteAllKeyframes()
hou_parm.set(0.81699999999999995)


# Code for /mat/random_uv/mtlxrange2/outlow parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxrange2")
hou_parm = hou_node.parm("outlow")
hou_parm.deleteAllKeyframes()
...
# Code for /mat/random_uv/mtlxrange2/outhigh parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxrange2")
hou_parm = hou_node.parm("outhigh")
hou_parm.deleteAllKeyframes()
...
# Code for /mat/random_uv/mtlxadd6
...
# Code for /mat/random_uv/mtlxadd6/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxadd6")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
hou_parm.set("vector2FA")
...
# Code for /mat/random_uv/mtlxnoise2d1
...
# Code for /mat/random_uv/mtlxnoise2d1/amplitude parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxnoise2d1")
...
# Code for /mat/random_uv/mtlxmultiply8
...
# Code for /mat/random_uv/mtlxmultiply8/signature parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxmultiply8")
hou_parm = hou_node.parm("signature")
hou_parm.deleteAllKeyframes()
hou_parm.set("vector2")


# Code for /mat/random_uv/mtlxmultiply8/in2 parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxmultiply8")
...
# Code for /mat/random_uv/mtlxmultiply8/in2_vector2 parm tuple
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxmultiply8")
hou_parm_tuple = hou_node.parmTuple("in2_vector2")
hou_parm_tuple.deleteAllKeyframes()
...
# Code for /mat/random_uv/mtlxsubtract2
...
# Code for /mat/random_uv/mtlxsubtract2/in2 parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxsubtract2")
hou_parm = hou_node.parm("in2")
hou_parm.deleteAllKeyframes()
hou_parm.set(0.5)
...
# Code for /mat/random_uv/mtlxmultiply9
...
# Code for /mat/random_uv/mtlxmultiply9/in2 parm 
if locals().get("hou_node") is None:
    hou_node = hou.node("/mat/random_uv/mtlxmultiply9")
hou_parm = hou_node.parm("in2")
hou_parm.deleteAllKeyframes()
...
# Code for /mat/random_uv/mtlxrandomfloat1
...
# Code to establish connections for /mat/random_uv/mtlxstandard_surface
...
# Code to establish connections for /mat/random_uv/Material_Outputs_and_AOVs
...
# Code to establish connections for /mat/random_uv/mtlximage1
...
# Code to establish connections for /mat/random_uv/uv_scale
...
# Code to establish connections for /mat/random_uv/mtlxadd4
...
# Code to establish connections for /mat/random_uv/mtlxcellnoise2d1
...
# Code to establish connections for /mat/random_uv/mtlxmultiply5
...
# Code to establish connections for /mat/random_uv/uv_rotate
...
# Code to establish connections for /mat/random_uv/mtlxmodulo2
...
# Code to establish connections for /mat/random_uv/mtlxsubtract1
...
# Code to establish connections for /mat/random_uv/mtlxmultiply6
...
# Code to establish connections for /mat/random_uv/mtlxrange2
hou_node = hou_parent.node("mtlxrange2")
if hou_parent.node("mtlxcellnoise2d1") is not None:
    hou_node.setInput(0, hou_parent.node("mtlxcellnoise2d1"), 0)
# Code to establish connections for /mat/random_uv/mtlxadd6
...
# Code to establish connections for /mat/random_uv/mtlxnoise2d1
...
# Code to establish connections for /mat/random_uv/mtlxmultiply8
hou_node = hou_parent.node("mtlxmultiply8")
if hou_parent.node("mtlxtexcoord2") is not None:
    hou_node.setInput(0, hou_parent.node("mtlxtexcoord2"), 0)
# Code to establish connections for /mat/random_uv/mtlxsubtract2
...
# Code to establish connections for /mat/random_uv/mtlxmultiply9
...
# Code to establish connections for /mat/random_uv/mtlxrandomfloat1
